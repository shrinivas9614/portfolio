...
const AddVendors = () => {
  ...
  const formik = useFormik({ 
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        let item = { vid, vfullname, vemail, vpassword, vphone, vusername, vdealsname, vdealsdescriptions, vdealsprice };
        API.post('http://127.0.0.1:8000/backend_api/vendors/', item).then(() => refreshVendors());
    }

    const onUpdate =(vid) => {
      let item = [vid] 
      API.patch(`http://127.0.0.1:8000/backend_api/vendors/${vid}`, item)
      .then(() => refreshVendors());
               ...
               <h3 className="float-left">
                ...
                <Form onSubmit={onSubmit} className="mt-4">
                    <Form.Group className="mb-3" controlId="vid">
                        ...
                        <Form.Control type="text" placeholder="Enter Vendor ID" value={formik.value.vid} onChange={formik.handleChange}/>
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="vfullname">
                        <Form.Label>Vendor Full Name</Form.Label>
                        <Form.Control type="text" placeholder="Enter Vendor Full Name" value={formik.values.vfullname} onChange={formik.handleChange}/>

                    </Form.Group>
                    <Form.Group className="mb-3" controlId="vemail">
                        <Form.Label>Vendor Email</Form.Label>
                        <Form.Control type="text" placeholder="Enter Vendor Email" value={formik.values.vemail} onChange={(e) => formik.handleChange}/>
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="vpassword">
                        <Form.Label>Vendor Password</Form.Label>
                        <Form.Control type="password" placeholder="Enter Vendor Password" value={formik.values.vpassword} onChange={formik.handleChange}/>
                    ...
                    <Form.Group className="mb-3" controlId="vphone">
                        ...
                        <Form.Control type="text" placeholder="Enter Vendor Phone" value={formik.values.vphone} onChange={formik.handleChange}/>

                    </Form.Group>
                    <Form.Group className="mb-3" controlId="vusernames">
                        <Form.Label>Vendor Username</Form.Label>
                        <Form.Control type="text" placeholder="Enter Vendor Username" value={formik.values.vemailvusername} onChange={formik.handleChange}/>
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="vdealsname">
                        <Form.Label>Deals Name</Form.Label>
                        <Form.Control type="text" placeholder="Enter Deals Name" value={formik.values.vdealsname} onChange={formik.handleChange}/>


                    </Form.Group>
                    <Form.Group className="mb-3" controlId="vdealsdescription">
                        <Form.Label>Deals Description</Form.Label>
                        <Form.Control type="text" placeholder="Enter Deals Name" value={formik.values.vdealsdescriptions} onChange={formik.handleChange}/>

                    </Form.Group>
                    <Form.Group className="mb-3" controlId="vdealsprice">
                        <Form.Label>Deals Price</Form.Label>
                        <Form.Control type="text" placeholder="Enter Deals Price" value={formik.values.vdealsprice} onChange={formik.handleChange} />
                  ...
                  <tr key="">
                    ...
                    <td>
                      <i
                        ...
                        aria-hidden="true"  onClick={() => setSelectVendors(vendor)}
